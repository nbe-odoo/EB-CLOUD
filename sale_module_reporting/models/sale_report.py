...
class SaleReport(models.Model):
    ...
    untaxed_amount_undelivered12 = fields.Float(string='Untaxed Amount Left to Delivered', readonly=True)
    quantity_reserved11 = fields.Float(string='Quantity Reserved', readonly=True)
    quantity_undelivered12 = fields.Float(string='Qty Left to Delivered', readonly=True)
    ...
    def _query(self, with_clause='', fields={}, groupby='', from_clause=''):
        ...
        fields['untaxed_amount_undelivered12'] = ', sum(l.untaxed_amount_undelivered12) as untaxed_amount_undelivered12'
        fields['quantity_reserved11'] = ', sum(l.quantity_reserved11) as quantity_reserved11'
        fields['quantity_undelivered12'] = ', sum(l.quantity_undelivered12) as quantity_undelivered12'
